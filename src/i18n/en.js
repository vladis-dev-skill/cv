...
export default {
  ...
  job1_b4: 'Ran a major <b>PostgreSQL 14 → 18</b> upgrade on a ~<b>50 TB</b> cluster without pausing payment acceptance: logical replication, drift driven to zero before cut-over, one contour switched at a time with the option to step back at any point.',
  ...
  job3_b3: 'Covered what mattered with tests: <b>unit tests</b> over domain rules and <b>functional tests</b> over API scenarios — regressions in booking and calendars were caught before release, not in production.',
  ...
  job4_b2: 'Built the backend of a classifieds platform: a domain model shaped for search and filtering in <b>PostgreSQL</b>, a versioned <b>REST contract</b> in Swagger, automated builds and deployment through <b>GitLab CI</b>, and a collector pulling listings from external sources. The first place where I owned a system rather than individual tickets.',
